...
Checkboxes: <br />
<input type="checkbox" name="QPC" value="ON" > Checkboxes  
<br>
<input type="checkbox" name="QPA" value="ON" > Not this one<br>
<input type="checkbox" name="QLY" value="ON" checked="checked" > Selected choice
<br /><br />

<input type="image" name="submit" src="goto.gif" /><br /><br />
<input type="button" name="submit" value="Button" /><br /><br />
<input type="reset" name="submit" value="Reset" /><br /><br />
<input type="submit" name="submit" value="Submit" />  <img src="sunset.jpg" width="4cm" />
<br /><br />

<b>Select</b>
<select size="1" name="status"><option value="A">Active</option><option value="W" >New item from auto_manager: pending validation</option><option value="I" selected="selected">Incomplete record - pending</option><option value="X" >Flagged for Deletion</option> </select>Carry on immediately afterwards
<br /><br />
...
Text here should not still be in courier font.
</form>
