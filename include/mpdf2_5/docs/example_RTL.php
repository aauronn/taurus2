...
<h4>Urdu</h4>
<p>Urdu and Pashto contain characters not included in the standard fonts available with mPDF:</p>
...
<p>With Scheherazade font defined (as in-line CSS):</p>
...
\xc2\xb0\xe2\x88\x92\xc2\xb1\xc3\xb7\xe2\x81\x84\xc3\x97\xc6\x92\xe2\x88\xab\xe2\x88\x91\xe2\x88\x9e\xe2\x88\x9a\xe2\x89\x88\xe2\x89\xa0\xe2\x89\xa1\xe2\x88\x8f\xc2\xac\xe2\x88\xa9\xe2\x88\x82</p>
...
<p>Text is analysed chunk by chunk (between tags) and at the end of every block (div, p, td). By default all characters, and all words are reversed in order. If the text contains non-RTL characters (e.g. latin text), those characters are not reversed, but the words still are.</p>
...
<p>If the whole chunk of text (between any set of tags) consists of non-RTL characters, then the words are reversed also. In this example the english words are enclosed by simple &lt;span&gt; tags:</p>

<p>\xd9\x88\xd8\xa7\xd8\xaf\xd8\xa7\xd9\x86 \xd8\xa7\xd9\x84\xd8\xa8\xd9\x8a\xd8\xaa \xd8\xa7\xd9\x84\xd8\xa7\xd8\xa8\xd9\x8a\xd8\xb6 &quot;\xd8\xa8\xd8\xb4\xd8\xaf\xd8\xa9&quot; \xd8\xaa\xd9\x81\xd8\xac\xd9\x8a\xd8\xb1 <span>with some english in the middle</span> \xd8\xa7\xd9\x8a\xd9\x84\xd8\xa7\xd8\xaa \xd9\x81\xd9\x8a\xd9\x85\xd8\xa7 \xd8\xa7\xd8\xb9\xd8\xb1\xd8\xa8\xd8\xaa \xd9\x88\xd8\xb2\xd8\xa7\xd8\xb1\xd8\xa9</p>

<p>&lt;BDO&gt; tags can also be used - these serve two purposes: they act as dividers (as for span above), but they will also set \$mpdf->BiDirectionality to true. This does nothing when the page directionality is 'rtl'.</p>

<p>Note this is different to the function of \$mpdf->BiDirectional when the page directionality is 'ltr'</p>


<h3>Tables</h3>
<p>Tables are automatically transposed, although note that text alignment in cells is not overridden if set by stylesheet etc.</p>
...
<li>\xd8\xa7\xd9\x84\xd8\xa7\xd9\x85\xd8\xb1\xd9\x8a\xd9\x83\xd9\x8a
	<ul><li>\xd8\xac\xd9\x88\xd8\xb1\xd8\xac \xd8\xa8\xd9\x88\xd8\xb4 \xd9\x81\xd9\x8a \xd8\xac\xd9\x88\xd8\xb1\xd8\xac \xd8\xa8\xd9\x88\xd8\xb4 \xd9\x81\xd9\x8a \xd8\xac\xd9\x88\xd8\xb1\xd8\xac \xd8\xa8\xd9\x88\xd8\xb4 \xd9\x81\xd9\x8a \xd8\xac\xd9\x88\xd8\xb1\xd8\xac \xd8\xa8\xd9\x88\xd8\xb4 \xd9\x81\xd9\x8a \xd8\xac\xd9\x88\xd8\xb1\xd8\xac \xd8\xa8\xd9\x88\xd8\xb4 \xd9\x81\xd9\x8a \xd8\xac\xd9\x88\xd8\xb1\xd8\xac \xd8\xa8\xd9\x88\xd8\xb4 \xd9\x81\xd9\x8a \xd8\xac\xd9\x88\xd8\xb1\xd8\xac \xd8\xa8\xd9\x88\xd8\xb4 \xd9\x81\xd9\x8a</li>
...
//==============================================================
	$utest = strcode2utf("&#1575;&#1610;&#1604;&#1575;&#1578; &#1601;&#1610;&#1605;&#1575; &#1575;&#1610;&#1604;&#1575;&#1578; &#1601;&#1610;&#1605;&#1575;");		// Arabic - RTL
//==============================================================
...
$mpdf=new mPDF('he','A4','','',32,25,27,25,16,13); 

	$mpdf->useOddEven = 1;	// Use different Odd/Even headers and footers and mirror margins (1 or 0)
	$mpdf->SetLineHeightCorrection(1.3);

	$mpdf->SetDisplayMode('fullpage','two');

	$mpdf->SetTitle($utest);
	$mpdf->SetAuthor($utest);	// use UTF-8

	// To add a DRAFT watermark
	$mpdf->SetWatermarkText($utest);
	$mpdf->watermark_font = 'DejaVuSansCondensed';
	$mpdf->showWatermarkText = true;

	$mpdf->AddPage();

	$mpdf->Bookmark($utest);	// use UTF-8
...
//==============================================================
	...
	if (($mpdf->default_font == 'scheherazade') || ($mpdf->default_font == 'garuda') || ($mpdf->default_font == 'norasi')) {
		$mpdf->setSubstitutions(GetSubstitutions($mpdf->codepage,$mpdf->default_font));
	}
