...
// TOC TABLE OF CONTENTS +++++++++++++++++++++++++++++++++++++++++++++
	...
	$mpdf->WriteHTML('<pagebreak type="E" /><TOC font="" font-size="" indent="5" />');

   for ($i = 1; $i<21; $i++) {
	$mpdf->WriteHTML('<h4>'."\xd8\xa7\xd9\x84\xd9\x82\xd8\xb3\xd9\x85".' '.$i.'<bookmark content="'."\xd8\xa7\xd9\x84\xd9\x82\xd8\xb3\xd9\x85".' '.$i.'" level="0" /><tocentry content="'."\xd8\xa7\xd9\x84\xd9\x82\xd8\xb3\xd9\x85".' '.$i.'" level="0" /></h4>',2);
