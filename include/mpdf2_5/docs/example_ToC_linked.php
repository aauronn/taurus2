...
// TOC TABLE OF CONTENTS +++++++++++++++++++++++++++++++++++++++++++++
	...
	$mpdf->TOC('','',5,1,'','','',true,true);	// font-family (blank =  default), font-size (pts) blank = default, indent each level (mm)
					// 5,1 parameters set pagenumbering details from the new page onwards
					// Last parameter sets linking "on"
