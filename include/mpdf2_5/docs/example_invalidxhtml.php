...
<ol>
<li>Item <b><u>1</u></b>
<li>Item 2<sup>32</sup>
<li><small>Item</small> 3
...
<tr class="headerrow"><th>Col/Row Header
<td>
<p>Second column header p

<td>Third column header

<tbody>
<tr class="oddrow"><th>Row header 1
<td>This is data
<td>This is data

<tr class="evenrow"><th>Row header 2
<td>
<p>This is data p
...
<tr class="oddrow"><th>Row header 5
<td>Also data
<td>Also data

<tr class="evenrow"><th>Row header 6
<td>Also data
<td>Also data

<tr class="oddrow"><th>Row header 7
<td>Also data
<td>Also data

<tr class="evenrow"><th>Row header 8
<td>Also data
<td>Also data
...
Cras tellus. Fusce aliquet. Curabitur tincidunt viverra ligula. Fusce eget erat. Donec pede. Vestibulum id felis. Phasellus tincidunt ligula non pede. Morbi turpis. In vitae dui non erat placerat malesuada. Mauris adipiscing congue ante. Proin at erat. Aliquam mattis. 
...
<p>This is <s>strikethrough</s> in <b><s>block</s></b> and <small>small <s>strikethrough</s> in <i>small span</i></small> and <big>big <s>strikethrough</s> in big span</big> and then <u>underline</u> but out of span again but <font color="#000088">blue</font> font and <acronym>ACRONYM</acronym> text
<br /> 
...
<b>Select</b>
<select size="1" name="status"><option value="A">Active<option value="W" >New item from auto_manager: pending validation<option value="I" selected="selected">Incomplete record - pending<option value="X" >Flagged for Deletion </select> followed by text
<br /><br />
...
<dl>
<dt><a href="#links">Test pages for Unicode ranges</a><dd>Lists of Unicode characters that you can use to test the Unicode support of your Web browser and fonts.
<dt><a href="search.html">Search for a Unicode character</a><dd>Search the test pages to find any character that you want to use.
<dt><a href="fontsbyrange.html">Fonts for each Unicode range</a><dd>A list of Unicode ranges and the fonts that support them.
<dt>Unicode fonts<dd>Lists of fonts for <a href="fonts.html">Windows</a>, <a href="fonts_mac.html">Mac OS 9</a>, <a href="fonts_macosx.html">Mac OS X 10</a> and <a href="fonts_unix.html">Unix</a>, with the Unicode ranges they support, and where to obtain them.
<dt><a href="macbrowsers.html">Browsers for Apple Macintosh computers</a><dd>How to enable Unicode support in Web browsers under Mac OS 9.
<dt><a href="explorer.html">Internet Explorer for Windows</a><dd>How to enable Unicode support in IE 4, IE 5, IE 5.5 and IE 6.
<dt><a href="netscape.html">Netscape for Windows</a><dd>How to enable Unicode support in Netscape Communicator 4.x and 6.x.
<dt>Editors and word processors<dd>Applications for <a href="utilities_editors.html">Windows</a>, <a href="utilities_editors_mac.html">Mac OS 9</a>, <a href="utilities_editors_macosx.html">Mac OS X 10</a> and <a href="utilities_editors_unix.html">Unix</a> that can produce Unicode text, HTML and word processor documents.
<dt>File conversion, font and keyboard utilities<dd>Utilities for <a href="utilities_fonts_mac.html">Mac OS 9</a>, <a href="utilities_fonts_macosx.html">Mac OS X 10</a>, <a href="utilities_fonts.html">Windows</a> and <a href="utilities_fonts_unix.html">Unix</a> that can convert files to and from Unicode, view the characters in Unicode fonts, or re-map your keyboard to type Unicode characters.
<dt><a href="htmlunicode.html">Creating multilingual Web pages</a><dd>HTML code, fonts and editors to help you produce Web pages with multiple scripts and languages
</dl>

<p style="color:#880000; font-weight:bold; font-size:52pt" ><span style="color:#AAFFFF; outline-width:medium; outline-color:invert; ">OUTLINE Text.</span> 

Periodic Table
<div style="margin:12pt; background-color:#ddffaa; border:1px dashed #880000">
<table style="border:2mm dashed #888888; padding-left:1mm; padding-right:1mm; text-align:center;"><thead>
<tr><td>1A<th>2A<th>3B<th>4B<th>5B<th>6B<th>7B<th>8B<th>8B<th>8B<th>1B<th>2B<th>3A<th>4A<th>5A<th>6A<th>7A<th>8A
