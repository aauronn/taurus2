...
public class SuperPanel extends Panel
{
     ...
     *  @private
     */
    private function resizeHitBox_mouseOver(event:MouseEvent):void
    {
    	CursorManager.removeAllCursors();
    	CursorManager.setCursor(Iconos.RESIZE); 
    ...
    private function resizeHitBox_mouseOut(event:MouseEvent):void
    {
    	if(!_isResizing){
    		CursorManager.removeAllCursors();
    	}
    ...
    override protected function commitProperties():void
    {
    	...
    	if (resizeHitBox)
    	{
    		...
    		resizeHitBox.toolTip = "Redimensionar";
