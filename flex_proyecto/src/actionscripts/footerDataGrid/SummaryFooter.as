package actionscripts.footerDataGrid
{
    ...
    public class SummaryFooter extends UIComponent
    {
        ...
        public var useCurrencyFormatter:Boolean = false;
        ...
        public function set dataGrid(value:IFooterDataGrid):void
        {
            ...
            _dataGrid.addEventListener("headerShift", onHeaderShift);
        }
        ...
        private function onHeaderShift(event:IndexChangedEvent):void
		{
			if(columns.length>1){
				...
				var dataColumn:SummaryColumn = columns[oldIndex] as SummaryColumn;
        ...
        override protected function commitProperties():void
        {
            ...
            if ( columnsDirty && _label &&  dataGrid && dataGrid.columns && dataGrid.columns.length > 0 && !columns)
        ...
        private function generateColumns():Array
        {
            ...
            for (var index:int = 1; index < dataGrid.columns.length; index++)
            {
                ...
                else
                {
                    ...
                    dataColumn.useCurrencyFormatter = useCurrencyFormatter;
                }
...
//                        dataGrid.itemRenderer.newInstance();
                    ...
                    //daniel
                    if(columns.length==1){
                    	//var columnWidth:Number = columns.length==1 ? dataGrid.width : column.width;                
	                	renderer.setActualSize(dataGrid.width - 1, dataGrid.rowHeight);
                    }
        ...
        override protected function updateDisplayList(w:Number, h:Number):void
        {
            ...
            for each (var fdgc:IFooterDataGridColumn in columns)
            {
                ...
                var columnWidth:Number = columns.length==1 ? dataGrid.width : fdgc.column.width;
