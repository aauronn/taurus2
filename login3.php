		...
		<form id="forma_login" name="forma_login" method="post" action="login.php">
			<div align="center">
				<div id="login-box">
					...
					<div id="login-logo"><img src="imagenes/login-logo.png" width="140" height="45"/> </img></div>
					...
					<div id="login-box-field" style="margin-top:20px;">
						<input id="nombreusuario" name="nombreusuario" class="form-login" title="Username" value="" size="30" maxlength="2048" onKeyPress="javascript:checkKeyUser(event)" />
					</div>
					<br />
					<div id="login-box-name">Contrase&ntilde;a:</div>
						<div id="login-box-field"><input id="password" name="password" type="password" class="form-login" title="Password" size="30" maxlength="2048" onKeyPress="javascript:checkKeyPassword(event)" />
					</div>
					<br />
					<br />
					<br />
					<a href="javascript:login();"><img src="imagenes/login-btn.png" width="103" height="42" style="margin-left:90px;border-color: white;" /></a>
